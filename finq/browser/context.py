...
from finq.actions.base import Action
from finq.browser.node_type import InteractionNode, NodeCategory, finqNode
...
class Context:
    ...
    @staticmethod
    def format(node: finqNode, indent_level: int = 0, include_ids: bool = True, include_images: bool = False) -> str:
        indent = "  " * indent_level
    ...
    def subgraph_without(self, actions: list[Action]) -> "Context | None":
        ...
        def only_failed_actions(node: finqNode) -> bool:
